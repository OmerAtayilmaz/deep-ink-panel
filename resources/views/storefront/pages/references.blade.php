...
@endsection
@section('content')
    <div class="hero-2 overlay" style="background-image: url('{{asset('storefront')}}/images/references-banner.jpg');">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 mx-auto ">
                    <h1 class="mb-5 text-center"><span>{{__('pages.references.hero.title')}}</span></h1>
                    <div class="intro-desc text-left">
                        <div class="line"></div>
                        <p>{{__('pages.references.hero.description')}}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section sec-5">
        <div class="container">
            <div class="row mb-5">
                <div class="col-lg-6">
                    <h2 class="heading">{{__('pages.references.main.title')}}</h2>
                </div>
                <div class="col-lg-4">
                    <p>
                        {{__('pages.references.main.description')}}
                    </p>
                </div>
            </div>
