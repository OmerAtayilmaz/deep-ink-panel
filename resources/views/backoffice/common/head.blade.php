<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{asset('backasset')}}/dist/css/adminlte.min.css">
    <!-- overlayScrollbars -->
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="{{asset('backasset')}}/plugins/summernote/summernote-bs4.min.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Russo+One&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('backasset')}}/style.css"/>
    @livewireStyles
